...
import { savelabel } from '../../services/services';
...
export default function LabelEditbtn(props) {
  ...
  const save = () => {
    ...
    savelabel(props.id, label).then((result) => {
      ...
      //     if(props.heading=="Active / Pending Lines")
      //     {
      //     props.setData(value.filter((obj)=>obj.status_formated!="Subscription Closed"));
      //     props.settmpdata(value.filter((obj)=>obj.status_formated!="Subscription Closed"));
      //     }
      //     else{
