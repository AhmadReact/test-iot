...
import FastBasicPopover from "../main/mypages/orderlists/FastPopover";

import Skeleton from "./Skeleton";

function OrderSummaryForCombined(props) {
      ...
      <Paper className="relative flex flex-col flex-auto p-24  rounded-2xl shadow overflow-hidden mt-24 lg:mt-0">
        ...
        <div className="grid grid-cols-12 gap-x-4 mt-16">
                  ...
                  {obj.sim_prices >= 0 && (
                    ...
                    >
                      <div className="col-span-12 grid grid-cols-12 gap-x-4 cart-items ">
                        <div className="col-span-6 ">
                          <Typography className="text-lg font-medium flex ">
                            {obj.sim_name ? obj.sim_name : obj.sim_name}
          ...
          <Typography className="col-span-4 text-right">
            ...
            {formatNumber(
              props.tabValue === 0
                ? props?.itemsArray?.credit_card?.surcharge
                : props.tabValue === 1
                ? props?.itemsArray?.bank_account?.surcharge
                : props?.itemsArray?.credit_card?.surcharge,
            )}
          </Typography>
...
export default memo(OrderSummaryForCombined);
